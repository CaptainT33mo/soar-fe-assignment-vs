        ...
        <div className="w-full flex flex-col md:flex-row justify-center items-center md:items-start">
          <div className="mb-5 md:mb-0 md:ml-[30px] md:mr-[60px]">
            <div className="cursor-pointer relative rounded-full min-w-[100px] w-[100px] h-[100px] md:min-w-[90px] md:w-[90px] md:h-[90px] md:ml-[5px]">
              ...
              />
              <div className="absolute right-0 bottom-0 rounded-full w-[30px] h-[30px] bg-primary flex justify-center items-center text-white">
                <PenIcon />
              </div>
              <FormField
                control={form.control}
                        ...
                        <PopoverTrigger asChild>
                          <div className="relative cursor-pointer">
                            <Input
                              ...
                              readOnly
                            />
                            <ChevronDownIcon className="absolute right-[15px] md:right-[20px] bottom-[17px] md:bottom-[17px] text-text-secondary" />
                          </div>
                        </PopoverTrigger>
