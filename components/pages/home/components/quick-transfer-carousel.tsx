...
export const QuickTransferCarousel = ({
  ...
  return (
    ...
    >
      ...
      <CarouselNext
        className="bg-white min-w[40px] w-[40px] h-[40px] md:min-w[50px] md:w-[50px] md:h-[50px] shadow-carousel-button rounded-full hover:bg-white md:hover:bg-text-secondary/10 md:hover:shadow-none !ring-transparent text-secondary ring-offset-transparent border-transparent"
      />
    </Carousel>
  );
};